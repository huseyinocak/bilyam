                    ...
                    <div class="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
                        @foreach ($products as $product)
                            <article class="marketing-surface overflow-hidden p-5 hover:-translate-y-1">
                                ...
                                <div class="mt-4 border-t border-slate-200 pt-4 text-xs text-slate-500 dark:border-slate-800 dark:text-slate-400">
                                    Kurumsal talep akışı için çoklu ürün listesine eklenebilir.
                                </div>
                            </article>
                        @endforeach
                    </div>
