<x-guest-layout>
    <div class="mb-8 space-y-3">
        ...
        <h1 class="text-3xl font-semibold text-slate-900 dark:text-white">Yeni hesap oluşturun</h1>
        <p class="text-sm leading-6 text-slate-600 dark:text-slate-300">Üyelik teklif vermek için zorunlu değil, fakat teklif geçmişi ve tekrar talep gibi avantajlar sağlar.</p>
    </div>
